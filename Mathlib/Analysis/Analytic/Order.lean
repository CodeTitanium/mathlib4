...
@[deprecated (since := "2025-04-23")] alias AnalyticAt.order := eanalyticOrderAt
...
@[deprecated (since := "2025-04-23")] alias natCast_le_order_iff := natCast_le_eanalyticOrderAt
...
@[deprecated (since := "2025-04-23")] alias AnalyticAt.order_mul := eanalyticOrderAt_mul
...
@[deprecated (since := "2025-04-23")] alias AnalyticAt.order_pow := analyticOrderAt_pow
